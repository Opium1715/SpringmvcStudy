                        ...
                        <nav aria-label="Page navigation">
                            <ul class="nav">
                                ...
                                <c:if test="${pageInfo.hasPreviousPage }">
                                    <li><a href="${APP_PATH}/userList?PageNo=${pageInfo.navigateFirstPage}">首页</a></li>
                                    <li><a href="${APP_PATH }/userList?PageNo=${pageInfo.prePage}"
                                ...
                                <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                    ...
                                    <c:if test="${page_Num != pageInfo.pageNum }">
                                        <li><a href="${APP_PATH }/userList?PageNo=${page_Num}">${page_Num}</a></li>
                                    </c:if>
                                ...
                                <c:if test="${pageInfo.hasNextPage }">
                                    <li><a href="${APP_PATH }/userList?PageNo=${pageInfo.nextPage}"
                                           aria-label="Next"> <span aria-hidden="true">下一页</span>
                                    </a></li>
                                    <li><a href="${APP_PATH }/userList?PageNo=${pageInfo.pages}">末页</a></li>
                                </c:if>
